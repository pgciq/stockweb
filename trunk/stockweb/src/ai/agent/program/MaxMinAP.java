...
//					pivot = new MaxMinPivot(history,2);  // TEST
			...
			double perc = (MaxMinPivot.NO / (MaxMinPivot.NO + MaxMinPivot.OK)) * 100;
			
	        System.out.println("Quandidade de \n ACERTOS: " + MaxMinPivot.OK + " = " + ((perc - 100)*-1) + "\n ERROS: " + MaxMinPivot.NO + " = " + perc + "\n\n ");
	        System.out.println("Ganho porcentual = " + MaxMinPivot.totalPercent);
	        System.out.println("Perda porcentual = " + MaxMinPivot.totalPerdaPercent);
