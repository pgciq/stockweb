...
public class MaxMinIndex extends Indicator {
    ...
    public MaxMinIndex(QuoteHistory qh, double ajust01, double ajust02, double ajust03, double ajust04) {
        super(qh);
        init();
        checkAjustValue();
/*        this.ajust01 = ajust01;
        this.ajust02 = ajust02;
        this.ajust03 = ajust03;
        this.ajust04 = ajust04;
*/    }
    ...
    public void init(){
    	/* Existe uma diferença de ajuste quando a tendencia é de alta ou de baixa
    	   Estou setando a media entre a tendencia, seria bom se eu conseguisse identificar a tendencia e ajustar de acordo com elas.
    	*/
	...
	private void checkAjustValue(){
        String param = "";
		int days = Math.abs(Utils.differDays(String.valueOf(qh.getPriceBar(0).getDate()), String.valueOf(qh.getPriceBar(1).getDate()))); 
        ...
        this.ajust01 = Double.parseDouble(mapAjustIndex.get(param + "_index01"));
        this.ajust02 = Double.parseDouble(mapAjustIndex.get(param + "_index02"));
        this.ajust03 = Double.parseDouble(mapAjustIndex.get(param + "_index03"));
        this.ajust04 = Double.parseDouble(mapAjustIndex.get(param + "_index04"));
	}
    ...
    public double calculate() {
        ...
        // Essa rotina serve para verificar qual a minima mais provavel com base no valor da minima do dia anterior modificada -0.01 
