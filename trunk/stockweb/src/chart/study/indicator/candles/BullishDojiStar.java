...
public class BullishDojiStar extends Indicator {
	...
	public double calculate() {
		...
		boolean PrimeiroCandleGAP = CandleDoji && ((candle.Open(0) < candle.Open(1)) && (candle.Open(0) < candle.Close(1))) && (candle.High(0) < candle.Low(1));

		boolean DojiEstrelaAlta = SegundoCandleBaixa && PrimeiroCandleGAP && (TendenciaUltimosCandles==0);
