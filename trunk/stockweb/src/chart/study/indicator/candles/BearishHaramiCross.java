...
//		double SombraInf1 = candle.getCandleSize(0 ,2 ,2);
		...
		boolean PrimeiroCandleGAP = CandleDoji && ((candle.Close(0) > candle.Open(1)) && (candle.Close(0) < candle.Close(1))) && (candle.Open(0) > candle.Open(1)) && (candle.Open(0) < candle.Close(1));

		boolean HaramiCrossBaixa = (TendenciaUltimosCandles==1) && SegundoCandleBaixa && PrimeiroCandleGAP;
