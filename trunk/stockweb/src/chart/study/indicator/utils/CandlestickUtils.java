...
public class CandlestickUtils {
	...
	//Verifica se o candle é qualquer tipo de martelo ou enforcado
	public boolean isHangingManORHammer(QuoteHistory history){
		...
		boolean HangingMan = (Open1 != Close1) && ((percLargCandle1 > 10) && (percLargCandle1 <= 30)) &&  ( (SombraInf1 > CorpoCandle1*2) && ((SombraSup1 / (SombraInf1+CorpoCandle1) ) < 0.10) );
