...
/**
 * Hull Moving Average.
 * as defined at http://www.alanhull.com.au/hma/hma.html
 */
public class HMA extends Indicator {
    private final int length;

    /*
     * Public constructor of the indicator. Length should be 
     * at least 1 for meaningful results.
     */
    public HMA(QuoteHistory qh, int length) {
        super(qh);
        this.length = length;
    ...
    /* 
     * private utility to compute the weighted moving average of 
     * an array of doubles, of given length, ending at the 
     * given position of the array
     */
    private double WMA(double[] values, int end, int len)
    {	
