	...
	var jsonMenuDesktop = {
	    'main': [{
	        ...
	        "layout": [{
	            ...
	            "nodeRifer": "schema",
	            "innerHTML": "<img id='resize' src='img/icon_script.png'/>",
	            "style": ["top:45px", "width:128px", "height:128px", "left:150px", "position:absolute", "cursor:pointer"],
	            "events": [{
	                "onmousemove": eventMouseMove,
	                "onmousedown": function(){
	                    dragdrop.addEvent(document.getElementById('menuicon05'), 'move');
	                    listener.fire(['mousedown', 'menuicon05']);
	                },
	                "onclick": function(){
	                    document.getElementById('window05').style.visibility = 'visible';
	                }
	        ...
	        "layout": [{
	            ...
	            "nodeRifer": "schema",
	            "innerHTML": "<img id='resize' src='img/icon_script.png'/>",
	            "style": ["top:195px", "width:128px", "height:128px", "left:150px", "position:absolute", "cursor:pointer"],
	            "events": [{
	                "onmousemove": eventMouseMove,
	                "onmousedown": function(){
	                    dragdrop.addEvent(document.getElementById('menuicon06'), 'move');
	                    listener.fire(['mousedown', 'menuicon06']);
	                },
	                "onclick": function(){
	                    document.getElementById('window06').style.visibility = 'visible';
	                }
	        ...
	        "layout": [{
	            ...
	            "nodeRifer": "schema",
	            "innerHTML": "<img id='resize' src='img/icon_script.png'/>",
	            "style": ["top:345px", "width:128px", "height:128px", "left:150px", "position:absolute", "cursor:pointer"],
	            "events": [{
	                "onmousemove": eventMouseMove,
	                "onmousedown": function(){
	                    dragdrop.addEvent(document.getElementById('menuicon08'), 'move');
	                    listener.fire(['mousedown', 'menuicon08']);
	                },
	                "onclick": function(){
	                    document.getElementById('window08').style.visibility = 'visible';
	                }
...
var jsonStock = {
    ...
    'main': [{
        ...
        "layout": [{
            ...
            "innerHTML": "<div id='loadchart' style='visibility:hidden'><img src='img/loading.gif'/></div>&nbsp;&nbsp;Chart Stock",
...
var jsonChartSetting = {
    ...
    'main': [{
        ...
        "layout": [{
            ...
            "innerHTML": "<div id='loadchart' style='visibility:hidden'><img src='img/loading.gif'/></div>&nbsp;&nbsp;Analyzed Stock",
...
var jsonQuoteIndicatorAlert = {
    ...
    'main': [{
        ...
        "layout": [{
            ...
            "innerHTML": "&nbsp;<div id='contentwindow05'/>",

            "style": ["top:50px", "width:730px", "height:670px", "left:2px", "position:absolute", "backgroundColor:#f0f2f4"],
        ...
        "layout": [{
            ...
            "style": ["top:-10px", "left:0px", "height:20px", "width:730px", "backgroundImage:url(img/white-top-bottom.gif)"],

            "events": [{

                "onmousedown": function(){

                    dragdrop.addEvent(document.getElementById('window05'), 'move');

                    listener.fire(['mousedown', 'window05']);
        ...
        "layout": [{
            ...
            "innerHTML": "<div id='loadchart' style='visibility:hidden'><img src='img/loading.gif'/></div>&nbsp;&nbsp;",
        ...
        "layout": [{
            ...
            "style": ["top:655px", "left:0px", "height:15px", "width:730px", "backgroundImage:url(img/white-top-bottom.gif)"],

            "events": [{

                "onmousedown": function(){

                    //dragdrop.addEvent(document.getElementById('window05'), 'resize');
        ...
        "layout": [{
            ...
            "style": ["position:absolute", "top:-7px", "left:710px", "cursor:pointer"],
        ...
        "layout": [{
            ...
            "style": ["position:absolute", "top:655px", "left:715px"],
...
var jsonPerformance = {
    ...
    'main': [{
        ...
        "layout": [{
            ...
            "innerHTML": "&nbsp;<div id='contentwindow06'/>",
        ...
        "layout": [{
            ...
            "events": [{
                ...
                "onmousedown": function(){
                    ...
                    dragdrop.addEvent(document.getElementById('window06'), 'move');

                    listener.fire(['mousedown', 'window06']);
        ...
        "layout": [{
            ...
            "innerHTML": "<div id='loadchart' style='visibility:hidden'><img src='img/loading.gif'/></div>&nbsp;&nbsp;Performance",
        ...
        "layout": [{
            ...
            "events": [{
                ...
                "onmousedown": function(){
                    ...
                    //dragdrop.addEvent(document.getElementById('window06'), 'resize');
...
var jsonPerformanceTicket = {
    ...
    'main': [{
        ...
        "layout": [{
            ...
            "innerHTML": "&nbsp;<div id='contentwindow07'/>",

            "style": ["top:50px", "width:344px", "height:300px", "left:2px", "position:absolute", "backgroundColor:#f0f2f4"],
        ...
        "layout": [{
            ...
            "style": ["top:-10px", "left:0px", "height:20px", "width:344px", "backgroundImage:url(img/white-top-bottom.gif)"],

            "events": [{

                "onmousedown": function(){

                    dragdrop.addEvent(document.getElementById('window07'), 'move');

                    listener.fire(['mousedown', 'window07']);
        ...
        "layout": [{
            ...
            "style": ["top:285px", "left:0px", "height:15px", "width:344px", "backgroundImage:url(img/white-top-bottom.gif)"],

            "events": [{

                "onmousedown": function(){

                    //dragdrop.addEvent(document.getElementById('window07'), 'resize');
        ...
        "layout": [{
            ...
            "style": ["position:absolute", "top:-7px", "left:320px", "cursor:pointer"],
        ...
        "layout": [{
            ...
            "style": ["position:absolute", "top:285px", "left:329px"],
...
var jsonNotes = {
	    'main': [{
	        "layout": [{
	            ...
	            "params": [],
	            "nodeRifer": "schema",
	            "innerHTML": "&nbsp;<div id='contentwindow08'/>",
	            "style": ["top:50px", "width:730px", "height:670px", "left:2px", "position:absolute", "backgroundColor:#f0f2f4"],
	            "events": [{
	                "onmousemove": eventMouseMove
	            }]
	        ...
	        "layout": [{
	            ...
	            "events": [{
	                "onmousedown": function(){
	                    dragdrop.addEvent(document.getElementById('window08'), 'move');
	                    listener.fire(['mousedown', 'window08']);
	                }
	            }]
	        }]
	    }, {
	        "layout": [{
	            ...
	            "params": [],
	            "nodeRifer": "window08",
	            "innerHTML": "<div id='loadchart' style='visibility:hidden'><img src='img/loading.gif'/></div>&nbsp;&nbsp;Notes",
	            "style": ["position:absolute", "top:-8px", "left:10px", "color:#466F93", "fontWeight:bold", "fontFamily:verdana, arial, sans serif", "lineHeight:16px", "fontSize:12px"],
	            "events": [{}]
	        }]
