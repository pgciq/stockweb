...
public class MaxMinIndexAP extends AgentProgram{
	...
	public String getListMaxMinIndex(){
		...
		for(int i=1; i<history.getSize(); i++){
			...
			String maxMinIndex01 = String.valueOf(df.format(maxMinIndex.getMaxMinIndex01())).replace(",", ".");
			String maxMinIndex02 = String.valueOf(df.format(maxMinIndex.getMaxMinIndex02())).replace(",", ".");
			String maxMinIndex03 = String.valueOf(df.format(maxMinIndex.getMaxMinIndex03())).replace(",", ".");
			String maxMinIndex04 = String.valueOf(df.format(maxMinIndex.getMaxMinIndex04())).replace(",", ".");
			String maxMinIndex05 = String.valueOf(df.format(maxMinIndex.getMaxMinIndex05())).replace(",", ".");
	...
	public String getMaxMinIndex(){
		...
		String result = "{date:"+priceBar.getDate()+"," +
						" mmi01:"+maxMinIndex01+"," +
						" mmi02:"+maxMinIndex02+"," +
						" mmi03:"+maxMinIndex03+"," +
						" mmi04:"+maxMinIndex04+"," +
