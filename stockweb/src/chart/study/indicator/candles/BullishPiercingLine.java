...
public class BullishPiercingLine extends Indicator {
	...
	public double calculate() {
		...
		boolean PrimeiroCandleBaixa = ( CorpoCandle1 > (SombraSup1+SombraInf1) ) && ((candle.Open(0) < candle.Close(1)) && (candle.Close(0) < candle.Open(1))) && (candle.Open(0) < candle.Close(0)) && (candle.Close(0) >= candle.Open(1) - range50percCandle2); //&& (Low > candle.Open(1))
