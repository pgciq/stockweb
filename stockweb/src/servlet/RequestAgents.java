...
public class RequestAgents extends HttpServlet {
	...
	private StringBuffer formatterResultBollinger(String history,
	...
	private StringBuffer formatterResultCandle(String history,
			HttpServletRequest request, HttpServletResponse response) {
		StringBuffer sbResult = new StringBuffer();
	...
	private StringBuffer formatterResultMaxMinIndex(String history,
			HttpServletRequest request, HttpServletResponse response) {
		StringBuffer sbResult = new StringBuffer();
		StringTokenizer tokens = new StringTokenizer(history, "|");
		String tmp = "";
	...
	private StringBuffer formatterResultVariationPriceIndex(String history,
			HttpServletRequest request, HttpServletResponse response) {
		StringBuffer sbResult = new StringBuffer();
		StringTokenizer tokens = new StringTokenizer(history, "|");
	...
	private StringBuffer formatterResultVariationVolume(String history,
			HttpServletRequest request, HttpServletResponse response) {
		StringBuffer sbResult = new StringBuffer();
		StringTokenizer tokens = new StringTokenizer(history, "|");
	...
	private void loadStockName() {
		try {
			...
			String filename = getServletContext().getRealPath(
					"finance_yahoo.properties").toString();
